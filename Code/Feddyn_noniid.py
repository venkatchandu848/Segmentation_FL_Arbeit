...
def plot_iou(training_ious, validation_ious, filename="iou_vs_rounds (FedDyn Non-iid).png"):
    ...
    plt.title('Training and Validation mIoU vs Communication Rounds for FedDyn non-iid model')
...
def main_feddyn_noniid():
    ...
    with open("feddyn_noniid.txt", "w") as f:
    ...
    plot_iou(training_ious, validation_ious, filename="iou_vs_rounds (FedDyn non-iid).png")

    model_save_path = "feddyn_noniid_model.pth"
